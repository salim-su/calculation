...
export class DefaultInterceptor implements HttpInterceptor {
  constructor(private injector: Injector, private msgSrv: NzMessageService) {}
  ...
  private handleData(ev: HttpResponseBase): Observable<any> {
    ...
    switch (ev.status) {
      ...
      case 401:
        ...
        // break;
        // 修改人：mark
        // 修改时间： 2020-03-19 19：47
        // 说明：注释掉break，直接返回Observable
        return of(ev);
      case 403:
      case 404:
      case 500:
  ...
  clearNullParams(params: HttpParams): HttpParams {
    ...
    params.keys().forEach((x) => {
      if (params.get(x) !== undefined && params.get(x) != null) {
